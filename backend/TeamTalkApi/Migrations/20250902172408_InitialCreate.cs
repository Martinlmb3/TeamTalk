        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<Guid>(type: "uuid", nullable: false),
                    InviteStatus = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
                    SentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    TeamId = table.Column<Guid>(type: "uuid", nullable: false),
                    Role = table.Column<bool>(type: "boolean", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LobbyUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LobbyUsers_Lobbies_LobbyId",
                        column: x => x.LobbyId,
                        principalTable: "Lobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LobbyUsers_Messages_LastReadMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lobbies_TeamId",
                table: "Lobbies",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_LobbyUsers_LastReadMessageId",
                table: "LobbyUsers",
                column: "LastReadMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_LobbyUsers_LobbyId_UserId",
                table: "LobbyUsers",
